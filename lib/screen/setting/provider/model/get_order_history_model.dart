...
class GetOrderHistoryModel {
  ...
  GetOrderHistoryModel({this.response});
  ...
  static List<GetOrderHistoryModel> fromList(List<Map<String, dynamic>> list) {
    return list.map(GetOrderHistoryModel.fromJson).toList();
  }
